              ...
              <div className='flex flex-row justify-center'>
                ...
                <div className='h-[40px] ml-10'>
                  ...
                  >
                    <div
                      id='modal'
                      className={`border border-current px-[20px] py-[24px] w-36 h-32 bg-blue-gray-10 flex flex-col justify-around items-center gap-5 shadow-md absolute top-[5rem] -left-[4.5rem]`}
                    >
                    ...
                    <div className='absolute top-[59%] left-1/2 -translate-x-1/2 -translate-y-1/2'>
                      <svg
                        className={`fill-white stroke-1 stroke-[#2D4053]`}
                        xmlns='http://www.w3.org/2000/svg'
                        width='28'
                        height='29'
                        viewBox='0 0 28 29'
